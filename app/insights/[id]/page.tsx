    ...
    return (
        <main className="min-h-screen bg-zinc-950 text-zinc-50 selection:bg-indigo-500/30 overflow-hidden">
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
                 <div className="absolute top-[-20%] right-[-10%] w-[800px] h-[800px] bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 rounded-full blur-[120px] opacity-50" />
                 <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] bg-gradient-to-tr from-blue-500/10 via-teal-500/10 to-emerald-500/10 rounded-full blur-[100px] opacity-30" />
            </div>
